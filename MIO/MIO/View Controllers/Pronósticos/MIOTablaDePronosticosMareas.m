...
- (UIView *)pieDeVistaDePronosticos{
    ...
    fechaDePronostico.text = [NSString stringWithFormat:@"%@%@%@%@", @"Válido del ", [primerDiaDePronostico format:@"EEEE d 'de' MMMM"], @" al ", [ultimoDiaDePronostico format:@"EEEE d 'de' MMMM 'de' YYYY"]];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    int umbral = 50;
    //Si el desplazamiento del contenido de la vita arrastrable sobrepasa el umbral comenzar a desaparecer el encabezado
